  ...
  const steps = [
    {
      ...
      description:
        "Explore our algorithm visualizations and interactive learning tools to get started.",
    },
    {
      step: 2,
      title: (
      ...
      description:
        "Use our interactive visualizations to understand how algorithms work step by step.",
    },
    {
      step: 3,
      title: (
    ...
    <div className="theme-container contribute-page">
      ...
      >
        <div className="hero-content">
          <h1 className="hero-title">Welcome to CodeLens</h1>
          <p className="hero-subtitle">
            Learn algorithms through interactive visualizations and improve your coding skills
          </p>
      ...
      >
        <div className="section-content">
          <h2 className="section-title" data-aos="fade-up" style={{padding:"20px",size:"90px"}}>What is CodeLens?</h2>
