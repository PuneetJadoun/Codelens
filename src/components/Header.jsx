...
import { FaMoon, FaSun, FaCode, FaSearch, FaDatabase, FaBrain, FaUsers, FaBook, FaProjectDiagram, FaQuestionCircle, FaRocket, FaGraduationCap, FaEnvelope, FaUser, FaSignOutAlt } from 'react-icons/fa';
                    ...
                    <div className="logo">
                        <Link to="/" className="logo-link">
                            ...
                            <h1 className="navbar-heading">
                                Code<span className="highlight">Lens</span>
                            </h1>
                        </Link>
                    </div>
