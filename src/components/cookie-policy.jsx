...
const CookiePolicy = () => {
  ...
  const cookieSections = [
      ...
      additionalContent: (
        <div className="comparison-table">
          ...
          <div className="table-row">
            ...
            <div>Varies</div>
            <div>Set directly by CodeLens</div>
          </div>
          <div className="table-row">
            <div>
    ...
    },
    {
      ...
      content:
        "By continuing to use CodeLens, you consent to our use of cookies as described in this policy. You can withdraw consent at any time by adjusting your browser settings or contacting us.",
    },
    {
      id: "updates",
      icon: "🔄",
