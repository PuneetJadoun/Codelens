...
const faqs = [
  {
    ...
    answer: "CodeLens is an interactive web application designed to help users visualize and understand various sorting and searching algorithms in real-time.",
    keywords: [
      { word: "codelens", weight: 10 }, 
      { word: "about", weight: 5 },
  ...
  },
  {
    ...
    answer: "Yes! CodeLens is completely free to use. You can access all features without any cost, and there are no advertisements or premium subscriptions required.",
    keywords: [
      { word: "free", weight: 10 },
      { word: "cost", weight: 10 },
