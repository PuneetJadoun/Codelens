...
export default function About() {
  ...
  return (
    <div className="about">
      ...
      >
        <h2 className="about-title">About CodeLens</h2>
      ...
      >
        <p className="about-text">
          CodeLens is an interactive web application designed to help
          ...
          CodeLens makes learning intuitive and engaging.
        </p>
      </div>

      {/* Why CodeLens Dropdown */}
      <div
        ...
        {openDropdown === "mission" && (
          <div className="dropdown-content">
            <p className="about-text">
              ...
              an experienced programmer refining your knowledge, CodeLens
